package com.example.filemanager.dbService.dao;



import com.example.filemanager.dbService.dataSets.UsersDataSet;
import com.example.filemanager.dbService.executor.Executor;
...
public class UsersDAO {
    ...
    public void insertUser(String login, String password, String email) throws SQLException {
        executor.execUpdate(
                "insert into users (user_login, user_password, user_email) values (?, ?, ?)",
